 ...
 */
{
  "lines": {
       ...
       "camera": [
         ...
         { "enabled": false, "from": 350, "to": 500, "inmeters": true, "thickness": 1,   "alpha": 30, "color": "0xEE0044"}
       ],
       ...
       "traverseAngle": [
         { "enabled": true, "from": 20,  "to": 500, "inmeters": true, "thickness": 0.4, "alpha": 35, "color": "0xFFCC66"}
       ]
    }
}